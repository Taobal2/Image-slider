    ...
    return (
        <div className="container">
            <div className="container_top">
                ...
                <div className="container_input"><Input type="file" onChange={upload}/></div>

            </div>
            <div className="input">
                <Input placeHolder="Enter your Name" value={name} onChange={
                    (e)=>{
            ...
            <div className="container1">
              <div className="button" ><BiLeftArrow onClick={prevState}/></div>
                  
              <div>
              <div>{statement1[page%statement1.length]}</div>
                  <img className="img" src={picture[page%picture.length]}/>
              </div>
              <div className="button"><BiRightArrow onClick={nextState}/></div>
            </div>
